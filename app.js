...
function renderModalPhase() {
  ...
  if (char.id === "fraux") {
    const frauxPhases = [
      {
        weapons: [
          { name: "화염의 권각 [스팅어 무기]", rating: "★★★★☆ (9/10)", desc: "1순위 (초반 권장). 엔딩 직후 가장 먼저 150레벨까지 해금하여 크리티컬 발생 확률을 100%에 맞춰 평타 2타 후 강공격 콤보의 스탠스 게이지 수급 효율을 극대화합니다." },
          { name: "데블 핑거 [수호 무기]", rating: "★★★☆☆ (6/10)", desc: "2순위 (생존용). 극초반 보스의 패턴 데미지를 버틸 피통이 부족할 때 대장간에서 즉시 임시 거치용으로 제작하여 착용합니다." }
        ],
        ...
        sigils: [
          ...
          { name: "혼신 V", sub: "대체: 폭군 V / 결사 V", desc: "체력이 가득 찼을 때 피해량 보정이 가장 큰 고화력 가성비 딜진입니다." },
          { name: "포션 보유 수 V", sub: "대체: 재생 V / 흡혈 V", desc: "회복 물약 개수를 2배로 증가시켜 초반 보스 패턴 미숙지로 인한 의문사를 완벽 방지." },
          { name: "수호 V", sub: "대체: 방어 V / 체력 가호", desc: "체력을 최소 35,000 이상 맞추어 보스의 일격 끔살을 피하는 기본 피통 진." },
          { name: "회피 성능 V", sub: "대체: 가드 성능 V", desc: "회피 연속 사용 횟수 및 무적 판정 시간을 늘려 안전한 게이지 충전을 보조." }
        ],
      ...
      {
        weapons: [
          { name: "천상무뢰 [각성 무기/어센션]", rating: "★★★★☆ (8/10)", desc: "1순위 (코어). 150레벨 풀강 및 대장간 10단계 풀각성 작업을 시작합니다. 깡공과 피통이 든든하게 올라 보스의 매운 대미지를 버틸 수 있게 지원합니다." },
          { name: "베가르드 권갑 [처단 무기/스턴]", rating: "★★★☆☆ (7/10)", desc: "2순위 (유틸). 보스의 그로기를 빠르게 유도해 아군의 링크 어택 시동을 돕는 유용한 유틸 무기." }
        ],
        skills: "파워 플랜트 (강렬한 힘 폭딜기) & 인도미누스 & 올 다운 구성. 콤보 피니시 후 R2 캔슬 컬랩스 연계로 쿨타임을 적극 회전시킵니다.",
        sigils: [
          { name: "데미지 상한 V", sub: "대체: 연계 공격 V", desc: "최소 3~4개 기용하여 데미지 상한을 45~50레벨 수준까지 끌어올립니다." },
          { name: "정의의 전용 진", sub: "대체: 대장간 전용 진 합성", desc: "프라우의 스탠스 충전 속도를 늘리고 어빌 쿨타임을 감소시키는 필수 시그니처 진." },
          { name: "폭군 V", sub: "대체: 혼신 V / 결사 V", desc: "피통 20% 감소의 패널티 대신, 상한선에 상시 도달하게 해주는 최고 효율의 딜진." },
          { name: "스턴 V", type: "유틸", sub: "대체: 연계 공격 V", desc: "보스의 기절치를 폭증시켜 아군 링크 찬스를 앞당깁니다." },
          { name: "포션 보유 수 V", sub: "대체: 흡혈 V", desc: "자가 회복 핵심." },
          { name: "자동 부활 (Guts)", sub: "대체: 근성 V / 수호 V", desc: "체력이 0이 되어도 버프 상실 없이 즉시 소생시켜 주는 최후의 1회용 보험." }
        ],
      ...
      {
        weapons: [
          { name: "데블 크로우 [최종 궁극/DLC]", rating: "★★★★★ (10/10)", desc: "1순위 (최종). 대장간에서 루시퍼/벨제붑 처치 시 드롭되는 '얼티메이트 메모리'를 사용해 직접 수동 제작하는 최강의 최종 기어입니다." },
          { name: "천상무뢰 [각성 완수]", rating: "★★★★☆ (8/10)", desc: "2순위 (과도기). 최종 무기를 제작하고 풀강화하기 전까지 프라우드 보스전을 견인할 든든한 풀각성 무기." }
        ],
        skills: "파워 플랜트 & 인도미누스 & 데드랜즈 (오의 게이지 가속용) 구성. 보스의 폭딜 무력화 기믹 시점에 맞춰 파워 플랜트를 최속 3연타 스팸합니다.",
        sigils: [
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "모든 보스를 역상성 약점으로 강제 찌르게 만드는 필수 사기 특수 진." },
          { name: "추가 대미지 V", sub: "대체: 혼신 / 결사 V", desc: "다단히트 콤보인 프라우의 실질 딜량을 확률적으로 20% 추가 상승시키는 최고 존엄 딜진." },
          { name: "데미지 상한 V", sub: "대체: 공격력/상한 한돌", desc: "65레벨 풀셋 완성. 무기 스킬 강화로 제한을 완벽하게 풉니다." },
          { name: "정의의 인도+ (합성진)", sub: "대체: 전용 진 V", desc: "전용 진에 고양이나 회피 성능이 2옵션으로 붙은 합성 시길을 장착합니다." },
          { name: "명경지수 V", sub: "대체: 회피 성능 V", desc: "저스트 회피 시 무적 시간 부여와 동시에 오의 게이지를 즉시 대폭 채워주는 극딜 가속진." },
          { name: "근성 V (Aegis)", sub: "대체: 수호 V / 방어 V", desc: "사망 데미지를 입어도 피 1을 남겨 무적 상태로 생존하게 하는 생존 시길." }
        ],
      ...
      {
        weapons: [
          { name: "데블 크로우 [초월 200레벨]", rating: "★★★★★ (10+/10)", desc: "1순위 (초월 종결). 대장간 무기 초월 시스템을 개방해 200레벨까지 돌파 완료. 신급 스탯 보정 및 4번째 전용 합성 옵션 슬롯이 개방되는 압도적인 종결 상태." },
          { name: "궁극의 마겸 [터미너스 200]", rating: "★★★★☆ (9/10)", desc: "2순위 (대안). 초월이 완료된 궁극 바하무트 무기로, 세팅 유동성에 따라 데블 크로우의 좋은 대안이 됩니다." }
        ],
        skills: "파워 플랜트 & 인도미누스 & 데드랜즈 & 올 다운 고정. 링크 타임 상태 진입 시 쿨감 100%를 받아 파워 플랜트만 스팸하여 수백만 버스트 딜을 뿜어냅니다.",
        sigils: [
          { name: "종말의 진 감마 (Dark Opus)", sub: "대체: 종말의 진 알파", desc: "루시퍼 처치 보상. 오의 배리어 보호막 보정과 함께 어빌리티 상한을 추가로 30% 더 확장." },
          { name: "종말의 진 베타", sub: "대체: 종말의 진 감마", desc: "어빌리티 자체 피해 배율을 늘려 파워 플랜트 한 방 데미지를 극한으로 증강시킵니다." },
          { name: "추가 대미지 V+", sub: "대체: 추가 대미지 V", desc: "유틸리티(포션 수/회피성능/고양)가 2옵션으로 붙은 최종 종결 진 세트." },
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "필수 장착." },
          { name: "퀵 어빌리티 V", sub: "대체: 맹렬 V", desc: "스킬의 재사용 대기시간을 강제로 0초대로 좁히는 핵심 쿨감 진." },
          { name: "고양 V", sub: "대체: 명경지수 V", desc: "오의 4체인을 최속으로 당기기 위한 세팅." }
        ],
    ...
    const cagliostroPhases = [
      {
        weapons: [
          { name: "베가르드 사수 [스팅어 무기]", rating: "★★★★☆ (9/10)", desc: "1순위 (코어). 초반 크리 확률 100% 세팅을 빠르게 구축하여, 아군 버프 판타즈마고리아 가동 시 딜 기여 크리 발생률을 보정하는 징검다리 스태프." },
          { name: "우로보로스 [Ruins/동료 무기]", rating: "★★★☆☆ (6/10)", desc: "2순위 (대체용). 스스팅어 제작 재료가 모자랄 때 대장간에서 임시 징검다리로 거쳐갈 때 유용한 스태프." }
        ],
        ...
        sigils: [
          ...
          { name: "혼신 V", sub: "대체: 폭군 V", desc: "버프와 맞물려 기본 데미지를 상한선 부근까지 도달시켜 주는 우수한 딜 진." },
          { name: "포션 보유 수 V", sub: "대체: 재생 V", desc: "체력 회복 물약 보유량을 늘려 자신과 파티의 안정성을 보강합니다." },
          { name: "수호 V", sub: "대체: 피통 가호", desc: "초반 보스에게 스치고 사망하는 빈사를 면할 수 있는 피통 확보." },
          { name: "가드 성능 V", sub: "대체: 회피 성능 V", desc: "보스의 타격을 L1 가드로 안전하게 튕겨내며 어빌 게이지를 모으기 위한 기본 안전진." }
        ],
      ...
      {
        weapons: [
          { name: "세이크리드 기어 [각성 무기/어센션]", rating: "★★★★☆ (8/10)", desc: "1순위 (코어 각성). 150레벨 풀강 및 대장간 10단계 풀각성 개방. 버퍼로서의 안정적인 기본 피통을 제공하여 보스의 광역 패턴 시 의문사하는 빈도를 줄여줍니다." },
          { name: "무한의 열쇠 [스턴 무기]", rating: "★★★☆☆ (7/10)", desc: "2순위 (스턴 보강). 적 보스의 쉴드 스턴치를 빠르게 깎아내기 위한 보조 유틸용 스태프." }
        ],
        skills: "판타즈마고리아 & 테제베 & 알렉산드리아 (스턴 게이지 시동용) & 리조마타 (원거리 즉발 소생 필수 채용).",
        sigils: [
          { name: "극치의 진리", sub: "대체: 대장간 전용 진 합성", desc: "피니시 적중 시 쿨타임 감소가 걸려 판타즈마고리아 공방크리 버프를 100% 상시 무한 유지하게 만드는 원동력." },
          { name: "데미지 상한 V", sub: "대체: 일반 딜진", desc: "데미지 상한 레벨을 45~50레벨로 맞추어 테제베의 타격당 데미지를 극대화." },
          { name: "자동 부활 (Guts)", sub: "대체: 근성 / 수호 진", desc: "힐러/서포터가 급사하면 파티가 터지므로, 1순위 자가 생존용 보험 진을 장착합니다." },
          { name: "포션 보유 수 V", sub: "대체: 흡혈 V", desc: "포션을 통한 아군 간접 세이빙 가속." },
          { name: "혼신 V", sub: "대체: 폭군 V", desc: "체력이 상시 높은 칼리오스트로와 어울리는 강력한 딜진." },
          { name: "수호 V", sub: "대체: Aegis V", desc: "기본 피통을 든든하게 메워주는 서포터 필수 생존 시길." }
        ],
      ...
      {
        weapons: [
          { name: "범천 세이크리드 기어 [궁극 무기/터미너스]", rating: "★★★★★ (10/10)", desc: "1순위 (최종). 프로토 바하무트 드롭. 최종 궁극 무기이며, 공격력 버프와 맞물려 칼리오스트로의 참격 딜링 포텐셜을 폭발적으로 상승시킵니다." },
          { name: "세이크리드 기어 [각성 완수]", rating: "★★★★☆ (8/10)", desc: "2순위 (대안). 바하무트 궁극 무기 획득 전에 전천후로 활용할 수 있는 완성형 풀각성 무기." }
        ],
        skills: "판타즈마고리아 & 테제베 & 알렉산드리아 & 리조마타 구성. 판타즈마고리아를 계속 켜며 적 스턴치가 쌓였을 때 오의 체인을 시작합니다.",
        sigils: [
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "서포터도 준수한 딜을 넣게 만들어주는 개사기 진. 테제베 광선과 조화가 매우 훌륭합니다." },
          { name: "데미지 상한 V", sub: "대체: 퀵 어빌리티 V", desc: "65레벨 풀셋팅 완성. 퀵 어빌리티 진을 추가로 섞어 전용 진과 쿨감 역시너지를 극대화합니다." },
          { name: "추가 대미지 V", sub: "대체: 폭군 V", desc: "다단 히트 광선 딜의 딜 누수를 추가 타격으로 완벽 보완." },
          { name: "극치의 인도+ (합성진)", sub: "대체: 전용 진 V", desc: "전용 진에 오의 게이지 충전을 보조하는 고양 V 가 결합된 합성 진 채용." },
          { name: "명경지수 V", sub: "대체: 회피 성능 V", desc: "저스트 회피를 통해 오의 게이지를 급속 충전해 아군과의 4체인 발동을 서포트." },
          { name: "근성 V", sub: "대체: 자동 부활 V", desc: "치명적인 피해를 1 남기고 무적 상태로 넘기는 생존 필수템." }
        ],
      ...
      {
        weapons: [
          { name: "범천 세이크리드 기어 [초월 200레벨]", rating: "★★★★★ (10+/10)", desc: "1순위 (초월 종결). DLC 라그나로크 최종 무기 초월 200레벨 달성. 막대한 기본 체급 보정 및 추가 슬롯이 열려 최종 버스트 유틸을 지원합니다." },
          { name: "황천무뢰 [DLC 제작]", rating: "★★★★☆ (9/10)", desc: "2순위 (대안 무기). 얼티메이트 메모리로 대장간에서 제작해 상성에 최적화할 수 있는 DLC 신무기." }
        ],
        skills: "판타즈마고리아 & 테제베 & 알렉산드리아 & 리조마타 고정. 아군 부활 및 상시 공방 30% 증가 버프로 전장을 안정적으로 리드합니다.",
        sigils: [
          { name: "종말의 진 알파 (Dark Opus)", sub: "대체: 종말의 진 감마", desc: "루시퍼 처치 보상. 파티 버스트 가속 코드 진을 섞어, 칼리오스트로 오의 발동 시 파티원 전체 오의 게이지를 추가 가속합니다." },
          { name: "종말의 진 감마", sub: "대체: 종말의 진 알파", desc: "오의 배리어 보호막 보정과 함께 어빌리티 상한을 추가로 30% 더 확장." },
          { name: "추가 대미지 V+", sub: "대체: 추가 대미지 V", desc: "유틸리티(포션 수/회피성능/고양)가 2옵션으로 붙은 최종 종결 진 세트." },
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "필수 장착." },
          { name: "퀵 어빌리티 V", sub: "대체: 맹렬 V", desc: "전용 진과 융합하여 판타즈마고리아의 쿨타임을 15초 미만으로 단축시킵니다." },
    ...
    const zetaPhases = [
      {
        weapons: [
          { name: "브리오낙 [스팅어 무기]", rating: "★★★★☆ (9/10)", desc: "1순위 (코어). 공중 체공 연속 공격(콩콩이) 콤보가 상시 크리티컬로 명중해 딜 편차를 없애기 위한 징검다리 필수 크리 창." },
          { name: "황금의 삼지창 [처단 무기/스턴]", rating: "★★★☆☆ (6/10)", desc: "2순위 (대안). 스팅어 무기 제작 전까지 적 보스를 기절 그로기로 눕히기 위한 유용한 창." }
        ],
        ...
        sigils: [
          ...
          { name: "혼신 V", sub: "대체: 폭군 V / 어택커 진", desc: "피통 피해 없이 공중 참격의 위력을 상한까지 배정하는 가성비 진." },
          { name: "포션 보유 수 V", sub: "대체: 체력 가호 V", desc: "물약 충전은 기본 소양. 공중 도약 실패 시 입는 피해 복구용." },
          { name: "수호 V", sub: "대체: Aegis V", desc: "피통 3만 선을 확보하여 끔살 패턴을 방지합니다." },
          { name: "회피 성능 V", sub: "대체: 명경지수 V", desc: "공중으로 뛰기 전 지상 장판 공격을 손쉽게 대처하는 유동 회피 보조." }
        ],
      ...
      {
        weapons: [
          { name: "알베스의 창 [각성 무기/어센션]", rating: "★★★★☆ (8/10)", desc: "150레벨 풀강 및 대장간 10단계 풀각성 달성. 제타의 깡공을 수직 상승시켜 공중 콤보 단발당 상한 도달률을 대폭 끌어올려 줍니다." },
          { name: "투기용 창 [동료 무기]", rating: "★★★☆☆ (7/10)", desc: "2순위 (징검다리). 각성 재료 은천의 빛 파밍이 고달플 때 대장간에서 높은 수치로 거쳐갈 수 있는 무기." }
        ],
        ...
        sigils: [
          ...
          { name: "데미지 상한 V", sub: "대체: 연계 공격 V", desc: "상한 3~4개 장착하여 45~50레벨 상한을 확보, 콩콩이 딜 누수를 방지합니다." },
          { name: "스턴 V", sub: "대체: 고양 V", desc: "제타의 스턴치 누적 능력을 배가시켜 보스를 끊임없이 그로기로 눞힙니다." },
          { name: "포션 보유 수 V", sub: "대체: 흡혈 V", desc: "회복량 서포트." },
          { name: "자동 부활", sub: "대체: 근성 V", desc: "낙사나 보스의 폭발에 쓸려 사망하는 위기를 1회 소생시키는 안전 진." },
          { name: "혼신 V", sub: "대체: 폭군 V", desc: "체공 시 피격이 적은 제타 특성상 항시 높은 딜 보정을 받는 최고 옵션." }
        ],
      ...
      {
        weapons: [
          { name: "게이볼그 [궁극 무기/터미너스]", rating: "★★★★★ (10/10)", desc: "1순위 (최종). 프로토 바하무트 드롭. 제타의 최종 종결 궁극 무기이며, 공중 루프 한 발당 화력을 사기적인 영역까지 끌어올립니다." },
          { name: "알베스의 창 [각성 완수]", rating: "★★★★☆ (8/10)", desc: "2순위 (대안). 바하무트 창 획득 전에 제타의 모든 콤보 화력을 온전히 투사해주는 풀각성 무기." }
        ],
        skills: "인피니트 원더즈 & 알베스의 공명 & 렐름스 마제스티 & 시그노 드라이브 구성. 보스가 날리는 광역기를 카운터 렐름스로 씹으며 맞공격을 날립니다.",
        sigils: [
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "상성 무관 약점 딜 보정. 추가 대미지 V 3개 조합과 결합하여 공중 콩콩이 참격 한 발 한 발을 우주급으로 강화시킵니다." },
          { name: "데미지 상한 V", sub: "대체: 한계돌파 크리 20%", desc: "65레벨 풀셋팅 필수 도달. 한돌로 크리를 당겨와 남은 진 슬롯에 배수/포션/자동부활을 든든하게 다집니다." },
          { name: "추가 대미지 V", sub: "대체: 결사 V", desc: "다단 히트 콩콩이 참격마다 추가 20% 대미지가 확정적으로 터지도록 배율 보정." },
          { name: "홍련의 인도+ (합성진)", sub: "대체: 전용 진 V", desc: "전용 진에 오의 게이지 상승인 고양 V가 결합된 최종급 전용 합성진." },
          { name: "명경지수 V", sub: "대체: 회피 성능 V", desc: "회피/렐름스 반격 저스트 성공 시 무적 부여 및 쿨타임을 급속 충전하는 코어 진." },
          { name: "근성 V", sub: "대체: 자동 부활 V", desc: "의문사를 막아줄 최종 생존 진." }
        ],
      ...
      {
        weapons: [
          { name: "게이볼그 [초월 200레벨]", rating: "★★★★★ (10+/10)", desc: "1순위 (초월 종결). DLC 라그나로크 최종 무기 초월 200레벨 달성. 공중 에어 콤보의 물리 타격 데미지를 무지막지하게 보정하며 최종 옵션 슬롯을 확보합니다." },
          { name: "천상창 [DLC 제작 무기]", rating: "★★★★☆ (9/10)", desc: "2순위 (대안). 얼티메이트 메모리를 활용해 제작하는 고스탯의 DLC 특화 창." }
        ],
        skills: "인피니트 원더즈 & 알베스의 공명 & 렐름스 마제스티 & 시그노 드라이브 고정. 루시퍼의 공중 패턴을 함께 날아오르며 요격합니다.",
        sigils: [
          { name: "종말의 진 알파 (Dark Opus)", sub: "대체: 종말의 진 감마", desc: "루시퍼 처치 보상. 에어 콤보 어빌리티 상한을 추가 돌파하고, 오의 발동 시 파티 시너지를 극대화하는 최종 종결 셋팅." },
          { name: "종말의 진 감마", sub: "대체: 종말의 진 알파", desc: "오의 베리어 실드 부여 옵션을 탑재하여 공중 생존과 오의 딜 상한을 동시에 보정." },
          { name: "추가 대미지 V+", sub: "대체: 추가 대미지 V", desc: "유틸리티(포션 수/회피성능/고양)가 2옵션으로 붙은 최종 종결 진 세트." },
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "필수 장착." },
          { name: "명경지수 V+", sub: "대체: 수호 V / 고양 V", desc: "공중 카운터 및 지상 저스트 회피 시 쿨다운과 무적 시간을 대폭 연장시켜 안전성과 극딜 순환율을 100% 채워줍니다." },
          { name: "퀵 어빌리티 V", sub: "대체: 맹렬 V", desc: "지상/공중 콤보 피니시 쿨타임 단축과 함께 시너지를 내는 최상급 쿨감 시길." }
        ],
    ...
    const beatrixPhases = [
      {
        weapons: [
          { name: "엠블럭스의 검 [스팅어 무기]", rating: "★★★☆☆ (8/10)", desc: "1순위 (코어). 마검 저스트 공격 시 치명타 발생률을 확보하기 위한 크리티컬 특화 징검다리 대검. 초반 마스터리 해금 전 필수 장비." },
          { name: "다크 액스 [처단 무기/스턴]", rating: "★★★☆☆ (6/10)", desc: "2순위 (대체용). 스팅어 대검이 만들어지기 전 거치용 대장간 검." }
        ],
        ...
        sigils: [
          ...
          { name: "배수 V (Enmity)", sub: "대체: 결사 V", desc: "피가 자주 깎이는 베아트리스 전용 최고 등급 딜 보조진." },
          { name: "포션 보유 수 V", sub: "대체: 흡혈 V", desc: "마검 폭딜 도중 소모되는 체력을 즉시 100% 복구할 코어 포션 진." },
          { name: "수호 V", sub: "대체: 피통 가호", desc: "체력이 1로 버텨도 기본 피통 한계선이 높아야 급사하지 않습니다." },
          { name: "회피 성능 V", sub: "대체: 가드 성능 V", desc: "저스트 공격 리듬 중 위험 패턴 긴급 회피 무적 보조." }
        ],
      ...
      {
        weapons: [
          { name: "에라스티아 [각성 무기/어센션]", rating: "★★★★☆ (8/10)", desc: "1순위 (각성 코어). 150레벨 풀강 및 대장간 10단계 풀각성 달성. 마검 폭딜 수치와 함께 자가 피소모 리스크를 견딜 든든한 깡체력을 대폭 늘려주는 주력 검." },
          { name: "불멸의 수호검 [수호 무기/체력]", rating: "★★★☆☆ (6/10)", desc: "2순위 (방어용). 각성 무기가 개방되기 전 피통 위주의 안정적 성장을 돕는 방어용 무기." }
        ],
        skills: "제피로스 & 임모탈리티 & 재밍 (이동 및 회피 무적 시간 버프) & 다크 익스플로전 (방깎 광역 폭발).",
        sigils: [
          { name: "불멸의 신념", sub: "대체: 대장간 전용 진 합성", desc: "콤보 공격 시 게이지 소모를 줄이는 전용 진 장착. 피통 상태에 상관없이 균일하게 상한을 치도록 배수와 혼신을 결합해 깡딜을 뻥튀기합니다." },
          { name: "데미지 상한 V", sub: "대체: 연계 공격 V", desc: "3~4개 기용하여 데미지 상한 레벨 45를 구축, 마검 참격의 최대 피해량을 해방." },
          { name: "배수 V", sub: "대체: 폭군 V", desc: "낮은 체력일수록 공격력을 증폭하여 자가 소모 리스크를 하이리턴으로 메웁니다." },
          { name: "포션 보유 수 V", sub: "대체: 흡혈 V", desc: "베아트리스의 제1 생명줄. 포션 수 V를 장착해 수시로 안전 피통 범위를 수동 복구합니다." },
          { name: "자동 부활 V", sub: "대체: 근성 V", desc: "마검 자폭 피해 및 의사 사망 시 즉시 소생 시켜주는 핵심 생존 보험." },
          { name: "수호 V", sub: "대체: Aegis V", desc: "체력 4만 선 돌파용 코어 시길." }
        ],
      ...
      {
        weapons: [
          { name: "플로렌시아 [궁극 무기/터미너스]", rating: "★★★★★ (10/10)", desc: "1순위 (최종). 프로토 바하무트 드롭 최종 대검. 베아트리스의 마검 강화 상태 저스트 참격 딜링을 리링크 한계 데미지 상한선까지 수직 상승시킵니다." },
          { name: "에라스티아 [각성 완수]", rating: "★★★★☆ (8/10)", desc: "2순위 (대안). 최종 무기를 제작하고 파밍하는 단계에서 보스 카운터 딜을 충분히 메워줄 풀각성 장비." }
        ],
        skills: "제피로스 & 임모탈리티 & 재밍 & 다크 익스플로전 구성. 적의 맹공 기믹 때 임모탈리티 무적을 키고 맞공격 대칭 딜을 전개합니다.",
        sigils: [
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "상성 우위 강제 속성 변환. 추가 대미지 V 3개와 결합해 저스트 타이밍 참격 한 방 한 방의 폭발력을 전 딜러 중 최강급으로 메웁니다." },
          { name: "데미지 상한 V", sub: "대체: 한계돌파 크리 20%", desc: "65레벨 풀셋팅 도달. 한돌로 크리를 당겨와 남은 진 슬롯에 배수/포션/자동부활을 든든하게 다집니다." },
          { name: "추가 대미지 V", sub: "대체: 결사 V", desc: "마검 저스트 평강공 한 타 한 타마다 20%의 추가 딜을 폭발시킵니다." },
          { name: "불멸의 인도+ (합성진)", sub: "대체: 전용 진 V", desc: "전용 진과 함께 오의 게이지 수급(고양 V)이 합쳐진 최고의 합성진 기용." },
          { name: "명경지수 V", sub: "대체: 회피 성능 V", desc: "저스트 회피 시 무적 부여 및 전체 쿨타임을 회복하는 코어 유틸 진." },
          { name: "근성 V", sub: "대체: 자동 부활 V", desc: "사망 직전 피 1 무적 소생을 돕는 필수 생존 진." }
        ],
      ...
      {
        weapons: [
          { name: "플로렌시아 [초월 200레벨]", rating: "★★★★★ (10+/10)", desc: "1순위 (초월 종결). DLC 라그나로크 최종 무기 초월 200레벨 해금. 마검 강화 저스트 공격력의 물리 캡 수치를 초월 급으로 상향 조정하며 최종 합성 슬롯을 제공." },
          { name: "칠흑의 무뢰검 [DLC 제작 대검]", rating: "★★★★☆ (9/10)", desc: "2순위 (대안). 루시퍼의 얼티메이트 메모리 재료로 수동 제작하는 확장팩 최적화 속성 대검." }
        ],
        skills: "제피로스 & 임모탈리티 & 재밍 & 다크 익스플로전 고정. 임모탈리티 무적의 딜증가 버프를 연계해 보스를 한순간에 녹여냅니다.",
        sigils: [
          { name: "종말의 진 베타 (Dark Opus)", sub: "대체: 종말의 진 감마", desc: "루시퍼 처치 보상. 베아트리스의 저스트 강공 막타 물리 딜을 극한으로 돌파시키고 오의 가속을 돕는 최종 종결 진 세팅." },
          { name: "종말의 진 감마", sub: "대체: 종말의 진 베타", desc: "오의 사용 시 실드 베리어를 제공하고 궁극 오의 딜링 한계를 추가 뚫어주는 사기 진." },
          { name: "추가 대미지 V+", sub: "대체: 추가 대미지 V", desc: "유틸리티(포션 수/회피성능/고양)가 2옵션으로 붙은 최종 종결 진 세트." },
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "필수 장착." },
          { name: "명경지수 V+", sub: "대체: 퀵 어빌리티 V / 맹렬 V", desc: "저스트 회피 시 무적과 쿨감 가속을 극대화하여, 제피로스 및 임모탈리티 무적 쿨을 빠르게 돌려 생존과 버스트 루프를 상시 유지하는 스펙." },
          { name: "배수 V+", sub: "대체: 결사 V+", desc: "체력이 깎인 상태에서 딜을 극한으로 뿜기 위한 유틸 합성형 배수 최종 진." }
        ],
    ...
    const defaultPhases = [
      {
        weapons: [
          { name: "스팅어 무기 (크리티컬 확률)", rating: "★★★★☆ (9/10)", desc: "1순위 (초반 필수). 스토리 완료 후 크리 확률 100% 세팅을 빠르게 구축하기 위한 필수 징검다리 무기." },
          { name: "수호 무기 (체력 특화)", rating: "★★★☆☆ (6/10)", desc: "2순위 (대안). 초반 HP 통을 든든하게 메워 의문사를 예방하기 위한 보조 무기." }
        ],
        ...
        sigils: [
          ...
          { name: "혼신 V", sub: "대체: 공격력 증가 V", desc: "깡공 수치를 늘려 데미지 상한에 닿게 만드는 필수 딜진." },
          { name: "포션 보유 수 V", sub: "대체: 재생 V", desc: "초반 물약 개수 확보를 통한 가성비 생존 보충." },
          { name: "수호 V", sub: "대체: 방어 V", desc: "피통 35,000 수준을 맞추는 초보 기본 가이드." },
          { name: "회피 성능 V", sub: "대체: 가드 성능 V", desc: "회피 무적 프레임을 추가 확보하여 보스 기믹을 회피." }
        ],
      ...
      {
        weapons: [
          { name: "각성 무기 (어센션)", rating: "★★★★☆ (8/10)", desc: "1순위 (코어). 150레벨 풀강 및 대장간 각성 10단계 달성. 피통과 깡딜을 든든하게 다져 의문사하는 빈도를 대폭 줄여줍니다." },
          { name: "스턴 무기 (기절 특화)", rating: "★★★☆☆ (7/10)", desc: "2순위 (대체). 기절 그로기를 빨리 뽑아 연계 콤보 스타트를 보조하기 위한 무기." }
        ],
        skills: "핵심 주력 딜링기 및 파티 방깎/생존 디버프 스킬 세팅.",
        sigils: [
          { name: "캐릭터 전용 진 V", sub: "대체: 포션 보유 수 V", desc: "대장간에서 전용 진을 1순위로 제작. 캐릭터의 전용 고유 성능을 개방합니다." },
          { name: "데미지 상한 V", sub: "대체: 딜 보정 가호", desc: "데미지 상한 45레벨 수준을 목표로 차분히 강화 시길을 추가해 갑니다." },
          { name: "자동 부활", sub: "대체: 근성 / 수호 진", desc: "1순위 자가 생존용 보험 진을 장착하여 매끄러운 퀘스트 클리어를 도모." },
          { name: "폭군 V", sub: "대체: 혼신 V", desc: "공격력을 크게 상승시켜 마스터리 완료에 따른 상한 딜 도달 보조." },
          { name: "수호 V", sub: "대체: Aegis V", desc: "체력을 40,000 수준으로 든든하게 다지는 셋팅." },
          { name: "스턴 V", sub: "대체: 고양 V", desc: "보스 기절치 누적 가속을 통한 딜 타임 창출." }
        ],
      ...
      {
        weapons: [
          { name: "궁극 무기 (터미너스)", rating: "★★★★★ (10/10)", desc: "1순위 (종결). 프로토 바하무트 드롭 최강 장비. 공격력 기본 스탯을 극단적으로 뻥튀기해 줍니다." },
          { name: "각성 무기 [각성 완수]", rating: "★★★★☆ (8/10)", desc: "2순위 (대안). 궁극 무기 파밍이 완료되기 전까지 프라우드 최종 보스 사냥을 견인하는 무기." }
        ],
        skills: "보스의 폭딜 카운터 셋팅 및 생존기 적극 기용.",
        sigils: [
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "약점 딜 보정 사기 진. 추가 대미지 V와 결합하여 딜링을 극대화합니다." },
          { name: "데미지 상한 V", sub: "대체: 한계돌파 크리 20%", desc: "65레벨 풀셋팅 완료. 깡딜 상한을 모두 확보합니다." },
          { name: "추가 대미지 V", sub: "대체: 혼신 V / 폭군 V", desc: "공격 시 확률적으로 20%의 추가 딜 레이어를 얹어 전체 화력을 상승시킴." },
          { name: "전용 합성진 V+", sub: "대체: 전용 진 V", desc: "전용 진과 함께 고양 또는 명경지수가 결합된 상위 진." },
          { name: "명경지수 V", sub: "대체: 회피 성능 V", desc: "회피 저스트 성공 시 무적 부여와 쿨감을 가져오는 최상급 유틸 진." },
          { name: "근성 V", sub: "대체: 자동 부활 V", desc: "사망 직전 생존을 확보하는 최종 보험." }
        ],
      ...
      {
        weapons: [
          { name: "궁극 무기 또는 DLC 최종 무기 [초월 200레벨]", rating: "★★★★★ (10+/10)", desc: "1순위 (초월). 무기 초월 200레벨 달성. 막대한 기본 체급 보정 및 추가 슬롯을 획득합니다." },
          { name: "최종 DLC 특화 무기", rating: "★★★★☆ (9/10)", desc: "2순위 (대안). 확장팩 던전 보상으로 제작하는 200레벨 성능의 보조 무기." }
        ],
        skills: "오의 체인 가속화 및 링크 타임 버스트 극대화 셋팅.",
        sigils: [
          { name: "종말의 진 (Dark Opus)", sub: "대체: 종말의 진 (보조)", desc: "루시퍼 처치 보상. 어빌리티 대미지 상한을 추가 돌파하고, 오의 발동 시 파티 시너지를 극대화하는 최종 종결 셋팅." },
          { name: "종말의 진 보조 코드", sub: "대체: 일반 합성진", desc: "게이지 충전 혹은 오의 후 데미지 상한을 추가 뚫어주는 확장팩 핵심 시길." },
          { name: "추가 대미지 V+", sub: "대체: 추가 대미지 V", desc: "유틸리티(포션 수/회피성능/고양)가 2옵션으로 붙은 최종 종결 진 세트." },
          { name: "유리 속성 변환", sub: "대체: 대체 불가", desc: "필수 채용." },
          { name: "명경지수 V+", sub: "대체: 퀵 어빌리티 V / 맹렬 V", desc: "저스트 회피 시 쿨다운과 무적 시간을 대폭 연장시켜 안전성과 극딜 순환율을 채워줍니다." },
          { name: "퀵 어빌리티 V", sub: "대체: 맹렬 V", desc: "어빌 쿨을 극도로 축소하여 딜 순환 효율을 종결시킵니다." }
        ],
    ...
    card2.innerHTML += `
      <div class="weapon-box">
        <div style="display: flex; justify-content: space-between; font-weight: bold; font-size: 11.5px; margin-bottom: 3px;">
          <span style="color: var(--accent-color);">${w.name}</span>
    ...
    ul.innerHTML += `
      <li style="margin-bottom: 10px; border-bottom: 1px dashed rgba(226,232,240,0.1); padding-bottom: 8px;">
        <div style="font-weight: 600; font-size: 13px; display: flex; justify-content: space-between; margin-bottom: 2px; align-items: center;">
          ...
          <span style="font-size: 10.5px; background: var(--badge-bg); color: var(--badge-text); padding: 1px 6px; border-radius: 4px;">대체: ${sig.sub}</span>
        </div>
